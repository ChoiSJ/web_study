...
<div class="container-fluid">
	<div class="panel panel-info">
		...
		<form method="post" action="../reviewPhotoUpload" enctype="multipart/form-data" name="insform" onsubmit="return checkform(this);">
					...
					<tr>
						...
						<td colspan="3">
							<span style="float:right">
								...
								<a href="reviewList.jsp" class="btn btn-info" role="button">목록</a>
							</span>	
						</td>
					</tr>
			</table>	
...
function checkform(){	
    ...
    //사이즈체크
    var selectedFile = document.getElementById('file-name').files[0];
