				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="form-group">
							<label>제목</label>
							<input name="title" type="text" class="form-control" id="qna-title" value="<%=(vo.getTitle())%>">
							<div id="empty-title"></div>
						</div>
						<div class="form-group">
							<label>내용</label>
							<textarea name="description" rows="5" class="form-control" id="qna-content"><%=(vo.getContent()) %></textarea>
